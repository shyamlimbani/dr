    ...
    <div style="width: 100%; max-width: 190mm; margin: 0 auto; box-sizing: border-box; padding-bottom: 20px; background-color: #ffffff;">
      ...
      <div class="report-container">
        ...
        <table class="header-table">
          <tr>
            ...
            <td class="header-center-col">
              ...
              <div class="report-subtitle">Employee Report</div>
            </td>
        ...
        <table class="data-table">
          ...
          <tbody>
            ${eventRows || '<tr><td colspan="3" style="padding: 10px; text-align: center; color: #64748b; font-style: italic;">No events found for this period.</td></tr>'}
          </tbody>
        </table>
        ...
        <table class="data-table">
          ...
          <tbody>
            ${paymentRows || '<tr><td colspan="3" style="padding: 10px; text-align: center; color: #64748b; font-style: italic;">No payments found for this period.</td></tr>'}
          </tbody>
        </table>
